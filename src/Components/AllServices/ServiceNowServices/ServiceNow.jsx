...
const ServiceNow = () => {
  // const containerWidth = movingImageRef.current.scrollWidth / 2; // Half since we duplicate images
  ...
  useEffect(() => {
    ...
    gsap.to(movingImageRef.current, {
      xPercent: 100, // Move full width to left
      ...
      <div className="flex justify-center mb-10">
            <button
              ...
              className={`w-[210px] h-[42px] font-raleway leading-[18.78px] text-[16px] font-bold rounded-[13px] p-[10px] gap-[10px] 
                form-item ${isDarkTheme ?'bg-white text-black hover:bg-gray-500' : 'bg-black text-white hover:bg-gray-500'}`
                }
              // ref={btnRef}
            >
  ...
  <div className="flex justify-left items-center mt-0.5 ml-20">
    ...
    />
     ...
     <p className='text-start ml-24 justify-start text-[1.3rem] font-normal leading-[1.837rem] tracking-[0.125rem] pt-6 mr-24 text-2xl' >At Softshala Technologies, we ensure that every stage of your ServiceNow journey is seamless and ROI-driven. Whether you’re  adopting the platform for the first time or enhancing your existing setup, our tailored approach guarantees measurable outcomes.</p>
  ...
  <div className="flex justify-left items-left ">
   ...
   <p className='text-start justify-start text-[1.3rem] font-normal leading-[1.837rem] tracking-[0.125rem] pb-3 mr-24 text-2xl' >Whether you&apos;re exploring ServiceNow for the first time or optimizing your existing platform, Softshala Technologies is your trusted partner. We bring unparalleled expertise and cutting-edge solutions to revolutionize your IT service delivery.</p>
   </div>
