        ...
        <div className="flex flex-col justify-start gap-6 ml-10">
          <div className="text-white text-left">
            ...
            <div className="flex items-center" ref={line2Ref}>
              <hr
                className="border-t-2 border-white my-2 w-[640px]"
                style={{
                  backgroundImage: "linear-gradient(to right, #9CFF00, #00D1FF)",
                  height: "2px",
                  border: "none",
          ...
          <div className="text-[2.875rem] font-medium mt-5 text-white tracking-[3.02px] leading-normal text-left" ref={paraRef}>
