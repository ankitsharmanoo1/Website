        ...
        <div className="flex flex-col justify-start gap-6 ml-10 mt-28">
          <div className=" text-left">
            ...
            <div className="flex items-center" ref={line2Ref}>
              <hr
                className="border-t-2  my-2 w-[523px]"
                style={{
                  backgroundImage: isDarkTheme
                    ? "linear-gradient(to right, #9CFF00, #00D1FF)"
                    : "linear-gradient(to right, #000000, #1F4B55)",
          ...
          <div
            className="text-[46px] font-medium mt-5 tracking-[3.02px] leading-normal text-left"
            ref={paraRef}
          >
          ...
          >
            <p>
              Accelerating your digital transformation with tailored Salesforce
              solutions
            </p>
          </div>
          ...
          <div className="firstdiv flex flex-col md:flex-row justify-between items-center mt-8 gap-8">
            <div className="text-left max-w-[920px] max-h-[190px] p-[10px] gap-[10px] ml-8">
              ...
              <div className="flex justify-left items-center mt-0.5">
                <hr
                  className="w-[530px] h-[1px] border-none"
                  style={{
                    backgroundImage: isDarkTheme
                      ? "linear-gradient(to right, #9CFF00, #00D1FF)"
                      : "linear-gradient(to right, #000000, #1F4B55)",
          ...
          <div className="seconddiv flex flex-col md:flex-row justify-between items-center mt-8 gap-8">
            ...
            <div className="text-left max-w-[920px] max-h-[190px] p-[10px] gap-[10px] md:order-2">
              ...
              <div className="text-left max-w-[920px] max-h-[190px] p-[10px] gap-[10px]">
                <ul className="list-disc pl-5 font-raleway font-medium  text-[20px] text-justify leading-[24.59px] tracking-[0.1em]">
                  <li>
                    Automated Case Management: Custom triggers to route cases to
                    specific agents based on criteria like geography or product
                    expertise
                  </li>
                  <li>
                    Custom Knowledge Articles: Development of article templates
                    with dynamic layouts and multilingual suppor.
                  </li>
                  <li>
