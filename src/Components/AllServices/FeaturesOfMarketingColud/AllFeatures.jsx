...
const AllFeatures = () => {
  return (
    <div className="flex flex-row justify-center gap-4">
         <div className="font-raleway FeaturesBox w-[17.1875rem] h-auto bg-white p-[0.625rem] text-[#000000] rounded-[0.9375rem] gap-[0.625rem] shadow-inner-custom flex flex-col items-center">
