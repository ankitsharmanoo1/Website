...
const ServiceNow = () => {
  return (
    <nav
    className="absolute left-[300px] top-0 flex flex-col p-[20px] gap-[10px] text-xl [font-family:'Raleway-Regular',Helvetica] text-white bg-[#343434] bg-opacity-80 w-[384px] h-auto rounded-[0px_21px_21px_21px] shadow-lg mt-14"
    role="navigation"
